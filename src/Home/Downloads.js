                        ...
                        <article className="col-md-8 col-sm-7">                         
                            ...
                            <table className="table table-reponsive table-condensed table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Emerging Trends in Science & Technology </td>
                                        <td><a href="http://zenopsys.net/soundarya_forms/sims/downloads/Emerging Trends in Science and Technology.pdf"><i className="fa fa-file-pdf-o"></i> Download PDF</a></td>                                    
                                    </tr>
                                </tbody>
                            </table>
