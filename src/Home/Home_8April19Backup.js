                 			 ...
                 			 <div className="col-md-3 col-xs-12 col-sm-6">
								<div className="col-md-12 col-xs-12 col-sm-12 events all-events">
									...
									<div className="section-content" >
										...
										<a className="read-more" href="/sims/#/News">All events<i className="fa fa-chevron-right"></i></a>
										</div>
									</div>
								</div>
		...
		<div className="col-md-3 col-xs-12 col-sm-6">
			<h3 className="heading">SIMS experience</h3>
                                ...
                                <div id="myCarousel" className="carousel slide" data-ride="carousel" data-interval="200">
                                        ...
                                        <div className="carousel-inner">
                                             <div className="item active">
                                                <img src="http://zenopsys.net/soundarya_forms/sims/youth1.jpg" alt=""/>
                                            </div>
                                             <div className="item">
                                                <img src="http://zenopsys.net/soundarya_forms/sims/youth2.jpg" alt=""/>
                                            </div>
                                             <div className="item">
                                                <img src="http://zenopsys.net/soundarya_forms/sims/youth3.jpg" alt=""/>
                                            </div>
                                            <div className="item">
