        ...
        return(<div className="content container">
         ...
         <div id="myCarousel" className="carousel slide" data-ride="carousel" data-interval="2000">
              	...
              	<a className="left carousel-control" href="#myCarousel" data-slide="prev">
                            ...
                            <div id="sport-table_wrapper" className="dataTables_wrapper form-inline dt-bootstrap no-footer"><div className="row"><div className="col-sm-6"><div className="dataTables_length" id="sport-table_length"></div></div></div><div className="row"><div className="col-sm-12"><table id="sport-table" className="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" width="100%" role="grid" aria-describedby="sport-table_info" style={{width:"100%"}}>
                                <thead>
