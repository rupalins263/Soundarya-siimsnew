        ...
        <div className="content container">
            <div className="page-wrapper">
                <header className="page-heading clearfix">
                    <h1 className="heading-title pull-left">Hostel Facilities</h1>
                ...
                <div className="page-content">
                    <div className="row page-row">
                        <article className="welcome col-md-8 col-sm-7">                         
                            <div id="myCarousel" className="carousel slide" data-ride="carousel">
                                        ...
                                        <div className="carousel-inner">
                                            <div className="item active">
                                                <img src="http://zenopsys.net/soundarya_forms/sims_images/CampusLife/hostel-1_CampusLife.jpg" alt=""/>
                                            </div>
                                            <div className="item ">
                                                <img src="http://zenopsys.net/soundarya_forms/sims_images/CampusLife/hostel-2_CampusLife.jpg" alt=""/>
                                            </div>
                                            <div className="item ">
                                                <img src="http://zenopsys.net/soundarya_forms/sims_images/CampusLife/hostel-3_CampusLife.jpg" alt=""/>
                                            </div>
                           ...
                           <p>We understand that most of the students moving away from home feel out of place; hence we strive to make the transition as smooth as possible by offering comfortable and safe stay in the campus. The Soundarya Institute of Management and Science offers separate hostels for boys and girls supervised 24X7 by wardens and vigilant security personnel. Life-on-campus not only helps students to study but to socialize with their peers. Students have the luxury of being located outside the bustle of the city, yet not far from the attractions of the city during weekends. Friendships generated in the students’ life lasts longer.</p>   <ul className="activities">
                           <p>Every effort is made to make students feel at home while their stay at the hostels.</p>
                           <h3 className="text sub-heading">The Hostel Facilities majorly comprise of:</h3>
                             <ul className="activities">
                                <li>Comfortable rooms with and without attach toilets.</li>
                                <li>Rooms designed to provide adequate moving space and proper ventilation on sound engineering principles.</li>
                                <li>Separate mess for each hostel serving sumptuous, hygienic and nutritious food to the hostlers.</li>                              
                            </ul>
                            ...
                            <p>The students have the advantage of getting guidance even after the college hours and at the weekends. Moreover, the students can join additional language courses like English, French, etc. during this time.</p>
