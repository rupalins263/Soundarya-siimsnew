...
export default class Gallery extends Component{
    ...
    componentDidMount(){
        axios.get("http://ec2-18-217-223-214.us-east-2.compute.amazonaws.com/SIMS/Albums")
             .then((res)=>{
                    console.log(res)
                    this.setState({
    ...
    getalbums(id){
              axios.get(`http://ec2-18-217-223-214.us-east-2.compute.amazonaws.com/SIMS/Image/${id}`)
             .then((res)=>{
                    console.log(res)
                    this.setState({
